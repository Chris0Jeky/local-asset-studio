...
- **`BATCH2.md`** — batch 2 executive TLDR + full tables.
...
| **Batch 2 model ids cited** | **75** |
| **Batch 2 new unique vs batch 1** | **59** |
| Batch 2 overlap (re-cited) | 16 |
...
- **Batch 2:** Klein Anatomy Fixer + FP8/GGUF Klein WFs; Z-Image quantized `2169712`; prefer GGUF/FP8 over BF16 on 16GB.
