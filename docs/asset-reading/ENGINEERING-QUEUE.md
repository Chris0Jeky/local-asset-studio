...
| Bounded library reads and persistent selection, #177 | Stable pagination under mutation cannot equate off-page with missing; Workspace replacement, query drift, metadata bloat and long-lived selections must remain distinct. | **Selected for this pass.** #222/#233/#273 already cover membership-count work, selection disclosure and DOM continuity. Add bounded transactional reads first, then one stacked read-only transport/client slice; keep existing consumers unchanged. |
