...
| FLOW-16 | Two clients edit from the same metadata snapshot | Stale same-field writes conflict without erasing confirmed edits | **reproduced open**, temporary actual SQLite store; #188 |
