...
| Is any Wan 2.2 output temporally coherent? | CURRENT_STATE, workflow-lab README | **The surviving clip is, because it barely moves.** `examples/workflow-lab/wan-retro-anime.mp4` (33 frames): face, hand and umbrella hold with no flicker or morphing; consecutive frames differ by a median of 0.48 grey levels, first against last by 6.8 (a slight head turn, the mouth, the rain). Small periodic jumps every 3–4 frames look like codec keyframes. The recorded failures were not re-checked. |
