...
SIZES = (256, 384, 512)
DEFAULT_SIZE = 384
THUMB_VERSION = 1  # bump when the rendering changes; cached files and ETags then change with it
...
def render(source, size):
    ...
    with Image.open(source) as image:
        ...
        alpha = image.mode in ("RGBA", "LA", "PA", "RGBa", "La") or (image.mode == "P" and "transparency" in image.info)
