...
(function(){
  ...
  enginePanel.onclick=e=>{
    ...
    try{
      const target=catalog.presets.find(p=>p.id===button.dataset.uxEngine),reason=StudioContinuation.combineSwitchReason(selected,target,referenceRecords);if(reason)throw Error(reason);
