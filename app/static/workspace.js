...
function renderAssets() {
  ...
  StudioAssetGrid.render($('#assetGrid'),assets,{workspaceId:assetState.workspace_id,selected:assetSelection,cardHTML:assetCardHTML,emptyHTML:assets.length?'':assetEmptyState(),focusFallback:$('#assetSearch')});
