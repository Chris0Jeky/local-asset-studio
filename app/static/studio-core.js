...
(function(root,factory){const core=factory();if(typeof module==='object'&&module.exports)module.exports=core;else root.StudioUX=core;})(globalThis,function(){
  ...
  const INTENTS=[
    ...
    {id:'restyle',name:'Borrow a look',verb:'Restyle',hint:'Image + style picture → image',description:'Keep this pose. Paint it in the look of another picture.',prefer:['style-pose-wai','style-pose-nova','style-pose-yumeflux'],accept:p=>!!p.reference_board&&!!p.last_reference&&(p.modality||'image')==='image'},
