...
(function(root,factory){const core=factory();if(typeof module==='object'&&module.exports)module.exports=core;else root.StudioUX=core;})(globalThis,function(){
  ...
  return{VIEWS,ACTIVE,ATTENTION,INTENTS,normalizeView,recipesFor,summarize,failureDetails,readiness,readinessItems,sceneEligibility,normalizeDraft,promptTransfer};
});
