...
3. `HUMAN_TODO.md` — owner decisions and actions; surface open items in every summary. Tick an item only when its completion is directly verified or the owner has answered, recording how and when; never infer a decision or art acceptance.
