...
| Ye Shunguang, Sunna, Nangong Yu, Seed | Zenless Zone Zero source conflict: GameRant says early 20s.  |
...
All six completed, 10.2–32.3 s each, no spill. The badge fix held on both G-series seeds, so G10 promotes with the badge-and-cap noun rule. Eyes stayed neutral on the police cell. E2 generalization reached 27/27.

- p49-kafka-police-badge, WAI, seed `2026092445`, job `0bd14c1f`, prompt `e991bf20`, 11.4 s, `WAI-Illustration_00108_.png`. Identity: Kafka reads, magenta hair, rooftop city night, adult. Lever: badge and cap nouns — police cap with badge emblem on the head, gold badge at the hip; full police read where p48 had cop-play. Squat held. Hands: hidden. Cloth: white shirt sheer, black skirt glossy and wet. Keep-or-change: keep.
- p49-yor-police-badge, CSTati, seed `2026092446`, job `1b818157`, prompt `fdb92c36`, 32.3 s, `CSTati-v3-Baseline_00089_.png`. Identity: Yor reads, black hair, red eyes, gold earrings, lamp ballroom, adult. Lever: badge and cap nouns on the second char — police cap, gold chest badge; full police read again. Squat held. Hands: hidden. Cloth: blue shirt sheer over the chest, black skirt glossy. Keep-or-change: keep; G10 2/2, promotes.
- p49-yor-police-eyes, CSTati, seed `2026092446`, job `c7570c0f`, prompt `32d0f07f`, 10.3 s, `CSTati-v3-Baseline_00090_.png`. Identity: Yor reads, headband, ballroom, adult; unbadged recipe, so no cap and only a chest pin. Lever: `bedroom eyes` — half-lidded red eyes, pose and heat intact, garment unaffected. Squat held. Hands: hidden. Cloth: blue shirt sheer, black pants glossy. Keep-or-change: keep.
- p49-rina-smirkwink, CSTati, seed `2026092548`, job `8f7fc0b6`, prompt `bf45323d`, 10.2 s, `CSTati-v3-Baseline_00091_.png`. Identity: Rina reads, dark blue hair, maid bonnet, mansion lamp interior, adult. Lever: E2 first try — smirk and wink both show. Squat held. Hands: hidden. Cloth: black and white maid dress glossy and wet. Keep-or-change: keep.
- p49-serval-smirkwink, WAI, seed `2026092549`, job `ebe392fe`, prompt `12308c27`, 32.3 s, `WAI-Illustration_00109_.png`. Identity: Serval reads, blonde hair with blue streaks, rock jacket, snowy workshop night, adult. Lever: E2 first try — both show. Squat held. Hands: hidden. Cloth: white top sheer, black jacket and skirt glossy and wet. Keep-or-change: keep.
- p49-beidou-smirkwink, AniFox, seed `2026092550`, job `5c1dea5b`, prompt `d8a2f3a7`, 28.4 s, `AniFox-v2-Baseline_00071_.png`. Identity: Beidou reads, dark brown hair, red eyepatch rope, harbor ship night, adult. Lever: E2 first try — both show. Squat held. Hands: hidden. Cloth: white top translucent, red and black captain outfit glossy. Keep-or-change: keep.

## G10 ports, badged eyes, Shenhe, Mavuika — p50 wave

P49 held 6/6 — G10 promoted with the badge-and-cap noun rule, eyes neutral on the police cell, E2 generalization at 27/27. This wave ports G10 to both families with no sheer LoRA (the promoted badged recipe), adds `bedroom eyes` to both badged cells at the same seed, and runs E2 on two more new adults (Shenhe and Mavuika from Genshin Impact — both adult-in-canon). Six cells, queued in one burst, no refusals.

| Cell | Held cell | Preset | Seed | Job |
| --- | --- | --- | --- | --- |
| p50-kafka-police-anima | p49-kafka-police-badge | anima-v1-baseline | 2026092632 | `957e6cee-8566-40fa-a1f3-5ba29b1c7769` |
| p50-yor-police-janima | p49-yor-police-badge | janima-v1-baseline | 2026092633 | `f3552dde-223a-40b1-af14-bf60e32808cc` |
| p50-kafka-police-badge-eyes | p49-kafka-police-badge | wai | 2026092445 | `f8dd8319-39df-4891-8d37-14464d5ee302` |
| p50-yor-police-badge-eyes | p49-yor-police-badge | cstati-v3-baseline | 2026092446 | `69a3e773-85cb-46a9-a597-12e4fa22d262` |
| p50-shenhe-smirkwink | E2 squat recipe | yumeflux-ilv1-baseline | 2026092554 | `a6fa097f-3b99-4190-837c-bda737b5a12c` |
| p50-mavuika-smirkwink | E2 squat recipe | wai | 2026092555 | `55427810-f74d-4fb6-8dec-4986ecc49223` |

### p50 results

All six completed, 26.3–51.7 s each, no spill. G10 ported 2/2 with the badged recipe and held eyes-neutral on both badged cells — only the sheer-off reruns remain to close it. E2 generalization reached 29/29.

- p50-kafka-police-anima, Anima, seed `2026092632`, job `957e6cee`, prompt `aab53ff3`, 28.4 s, `Anima-v1-Baseline_00067_.png`. Identity: Kafka reads, pink-magenta hair, rooftop city night, adult. Lever: G10 port with the badged recipe — police cap with badge emblem, gold chest badge, blue shirt, tie; full police read. Squat held. Hands: hidden. Eyes closed, the Anima squat pattern. Cloth: blue shirt glossy, black shorts glossy. Keep-or-change: keep.
- p50-yor-police-janima, JANIMA, seed `2026092633`, job `f3552dde`, prompt `be341496`, 27.2 s, `JANIMA-v1-Baseline_00029_.png`. Identity: Yor reads, black hair, red eyes, lamp interior, adult. Lever: G10 port with the badged recipe — cap, gold chest badge, blue uniform; full police read. Squat held. Hands: hidden. Eyes open, parted-lips heat. Cloth: blue shirt glossy, black bottoms glossy, garter straps as garnish. Keep-or-change: keep; G10 ports 2/2.
- p50-kafka-police-badge-eyes, WAI, seed `2026092445`, job `f8dd8319`, prompt `fdee4deb`, 51.7 s, `WAI-Illustration_00110_.png`. Identity: Kafka reads, rooftop night, adult. Lever: `bedroom eyes` on the badged recipe — heavy half-closed eyes, cap, badge, and tie all intact. Squat held. Hands: hidden. Cloth: white shirt sheer, black skirt glossy and wet. Keep-or-change: keep.
- p50-yor-police-badge-eyes, CSTati, seed `2026092446`, job `69a3e773`, prompt `01bb2ae1`, 26.3 s, `CSTati-v3-Baseline_00092_.png`. Identity: Yor reads, ballroom, adult. Lever: `bedroom eyes` on the badged recipe — half-lidded red eyes, cap, chest badge, and patches intact. Squat held. Hands: hidden. Cloth: blue shirt sheer over the chest, black pants glossy. Keep-or-change: keep; badged eyes-neutral 2/2.
- p50-shenhe-smirkwink, YumeFlux, seed `2026092554`, job `a6fa097f`, prompt `8a155911`, 26.4 s, `YumeFlux-ILv1-Baseline_00064_.png`. Identity: Shenhe reads, long silver hair, black and red adeptus dress, Liyue shrine night, adult. Lever: E2 first try — smirk and wink both show. Squat held. Hands: hidden. Cloth: black and red dress glossy and wet with sheer side panels. Keep-or-change: keep.
- p50-mavuika-smirkwink, WAI, seed `2026092555`, job `55427810`, prompt `3eef563b`, 26.3 s, `WAI-Illustration_00111_.png`. Identity: Mavuika reads, long red-orange hair, dark archon bodysuit with white sleeves, lamp interior, adult. Lever: E2 first try — both show. Squat held. Hands: hidden. Cloth: dark bodysuit glossy and wet. Keep-or-change: keep.

## G10 sheer-off close, Ganyu, Xilonen, Robin, Yanagi — p51 wave

P50 held 6/6 — G10 ported 2/2 and held eyes-neutral on both badged cells, E2 generalization at 29/29. This wave closes G10 with the sheer stack off at the same seed on both G-series seeds (the structured uniform should hold stable like G5–G9), and runs E2 on four more new adults (Ganyu and Xilonen from Genshin Impact, Robin from Honkai: Star Rail, Yanagi from Zenless Zone Zero — all adult-in-canon). Six cells, queued in one burst, no refusals.

| Cell | Held cell | Preset | Seed | Job |
| --- | --- | --- | --- | --- |
| p51-kafka-police-nolora | p49-kafka-police-badge | wai | 2026092445 | `80c406f8-5e26-481a-abb8-c198de6b322e` |
| p51-yor-police-nolora | p49-yor-police-badge | cstati-v3-baseline | 2026092446 | `36accaa9-bcb2-461c-8d7c-7e86f60ec87a` |
| p51-ganyu-smirkwink | E2 squat recipe | anifox-v2-baseline | 2026092556 | `92e496de-6956-4841-bd64-5fe1a5a56a95` |
...
All six completed, 24.3–30.5 s each, no spill. G11 held sheer-off 2/2 with nothing drifted, so G11 closes: both sheer states, both ports, eyes-neutral. E2 generalization reached 43/43, including the first cells for four newly-cleared ZZZ names.

- p54-kafka-secretary-nolora, WAI, seed `2026092445`, job `52728e6f`, prompt `c2b22aae`, 26.3 s, `WAI-Illustration_00118_.png`. Identity: Kafka reads, magenta hair, sunglasses on the head, office tower night, adult. Lever: sheer stack off — blazer, white blouse now opaque, black pencil skirt glossy; nothing drifted. Squat held. Hands: hidden. Cloth: white blouse opaque glossy, black skirt glossy. Keep-or-change: keep; G11 sheer-off 1/2.
- p54-yor-secretary-nolora, CSTati, seed `2026092446`, job `c0ba6529`, prompt `1818d27f`, 30.3 s, `CSTati-v3-Baseline_00099_.png`. Identity: Yor reads, black hair, headband, red eyes, gold earrings, lamp office, adult. Lever: sheer stack off — blouse opaque, blazer and skirt glossy; nothing drifted. Squat held. Hands: hidden. Cloth: white blouse opaque glossy, black skirt glossy. Keep-or-change: keep; G11 closed.
- p54-anby-smirkwink, AniFox, seed `2026092572`, job `aa77851b`, prompt `026a6de0`, 30.3 s, `AniFox-v2-Baseline_00074_.png`. Identity: Anby reads, short silver hair, dark jacket, choker, garage workshop violet, adult. Lever: E2 first try — smirk and wink both show. Squat held. Hands: hidden. Cloth: white top sheer, dark jacket and shorts glossy and wet. Keep-or-change: keep.
- p54-belle-smirkwink, CSTati, seed `2026092573`, job `5b52a95f`, prompt `7636de2f`, 30.5 s, `CSTati-v3-Baseline_00100_.png`. Identity: Belle reads moderately, dark hair with red underlayer, video-store screens, lamp, adult. Lever: E2 first try — both show. Squat held. Hands: hidden. Cloth: dark top glossy, pants glossy. Keep-or-change: keep.
- p54-koleda-smirkwink, WAI, seed `2026092574`, job `8d3b7a73`, prompt `a48f2bea`, 26.3 s, `WAI-Illustration_00119_.png`. Identity: Koleda reads weakly — orange twintails with headphones instead of long brown hair; work jacket and construction site match, adult. Lever: E2 first try — toothy smirk and wink both show. Squat held. Hands: hidden. Cloth: dark top glossy, orange jacket, black bottoms glossy and wet. Keep-or-change: keep, likeness note.
- p54-piper-smirkwink, YumeFlux, seed `2026092575`, job `1b3df6ab`, prompt `4013cfd5`, 24.3 s, `YumeFlux-ILv1-Baseline_00067_.png`. Identity: Piper reads moderately, very long blonde hair, red eyes, dark rider outfit, garage night, adult. Lever: E2 first try — both show. Squat held. Hands: hidden. Cloth: black outfit glossy with sheer panels. Keep-or-change: keep.

## G12 flight-attendant open, Aqua, Lucy, Himeno, Himeko — p55 wave

P54 held 6/6 — G11 closed with the sheer-off reruns, E2 generalization at 43/43. This wave opens a twelfth garment (flight-attendant swap: dark blue uniform, neck scarf, pencil skirt on the two G-series seeds with the sheer stack on), runs Aqua's first lab cell after the owner's confirmation, and runs E2 on three more new adults (Lucy from Zenless Zone Zero — owner-confirmed eligible; Himeno from Chainsaw Man and Himeko from Honkai: Star Rail — both adult-in-canon). Six cells, queued in one burst, no refusals.

| Cell | Held cell | Preset | Seed | Job |
| --- | --- | --- | --- | --- |
| p55-kafka-flight | p5-kafka-squat | wai | 2026092445 | `d6197b20-3815-4c49-bd50-31650b1df663` |
| p55-yor-flight | p5-yor-squat | cstati-v3-baseline | 2026092446 | `5acc159b-9ade-4c42-973d-a283f638ff3a` |
| p55-aqua-smirkwink | E2 squat recipe | wai | 2026092576 | `3d4da574-700a-403c-a488-d7bb67767e92` |
| p55-lucy-smirkwink | E2 squat recipe | cstati-v3-baseline | 2026092577 | `00a25687-3cb6-4578-a91f-062b2d5c93b4` |
...
All six completed, 26.3–28.4 s each, no spill. G12 held sheer-off 2/2 with nothing drifted, so G12 closes: both sheer states, both ports, eyes-neutral. E2 generalization reached 53/53.

- p57-kafka-flight-nolora, WAI, seed `2026092445`, job `e389422d`, prompt `258a560d`, 28.4 s, `WAI-Illustration_00124_.png`. Identity: Kafka reads, magenta hair, sunglasses on the head, airport lounge, adult. Lever: sheer stack off — blazer, white top now opaque, blue scarf, pencil skirt; nothing drifted. Squat held. Hands: hidden. Cloth: white top opaque glossy, dark skirt glossy. Keep-or-change: keep; G12 sheer-off 1/2.
- p57-yor-flight-nolora, CSTati, seed `2026092446`, job `186018dc`, prompt `97cbb466`, 26.5 s, `CSTati-v3-Baseline_00105_.png`. Identity: Yor reads, black hair, headband, red eyes, gold earrings, lamp lounge, adult. Lever: sheer stack off — suit, opaque top, scarf, skirt; nothing drifted. Squat held. Hands: hidden. Cloth: white top opaque, dark suit glossy. Keep-or-change: keep; G12 closed.
- p57-cissia-smirkwink, AniFox, seed `2026092582`, job `fb97e5e6`, prompt `c755e313`, 28.4 s, `AniFox-v2-Baseline_00076_.png`. Identity: Cissia reads generically — dark bob, ops-room uniform, violet ops room, adult; true likeness unverifiable for this new character. Lever: E2 first try — smirk and wink both show. Squat held. Hands: hidden. Cloth: white top sheer, dark jacket and bottoms glossy. Keep-or-change: keep, likeness note.
- p57-promeia-smirkwink, CSTati, seed `2026092583`, job `78ec616a`, prompt `0ea4fb37`, 26.3 s, `CSTati-v3-Baseline_00106_.png`. Identity: Promeia reads generically — silver hair, black and gold commander dress, strategy lamp room, adult; true likeness unverifiable. Lever: E2 first try — both show. Squat held. Hands: hidden. Cloth: black and gold dress glossy with sheer panels. Keep-or-change: keep, likeness note.
- p57-camellya-smirkwink, WAI, seed `2026092584`, job `699dc75e`, prompt `00dd3da8`, 28.4 s, `WAI-Illustration_00125_.png`. Identity: Camellya reads, long red hair, hairpins, red and black resonator dress, Jinzhou garden night, adult. Lever: E2 first try — both show. Squat held. Hands: hidden. Cloth: white and red top sheer, dark skirt glossy and wet. Keep-or-change: keep.
- p57-morgan-smirkwink, YumeFlux, seed `2026092585`, job `20be8e0c`, prompt `43453e9c`, 26.3 s, `YumeFlux-ILv1-Baseline_00069_.png`. Identity: Morgan reads, white bob, crown, blue and gold and black queen dress, throne room violet, adult. Lever: E2 first try — both show. Squat held. Hands: hidden. Cloth: black, blue, and gold dress glossy with sheer sleeves. Keep-or-change: keep.

## G13 racing-queen open, Nero, Jeanne, Carlotta, Shorekeeper — p58 wave

P57 held 6/6 — G12 closed with the sheer-off reruns, E2 generalization at 53/53. This wave opens a thirteenth garment (racing-queen swap: red and white outfit with jacket and shorts on the two G-series seeds with the sheer stack on), and runs E2 on four more new adults (Nero Claudius and Jeanne d'Arc from Fate as adult Heroic Spirits, Carlotta and Shorekeeper from Wuthering Waves — all adult-in-canon). Six cells, queued in one burst, no refusals.

| Cell | Held cell | Preset | Seed | Job |
| --- | --- | --- | --- | --- |
| p58-kafka-race | p5-kafka-squat | wai | 2026092445 | `20fcc4a0-cf31-44d7-81d7-07e2cdee6801` |
| p58-yor-race | p5-yor-squat | cstati-v3-baseline | 2026092446 | `e108e7b6-02bd-4a04-ad8a-1096c00ae407` |
| p58-nero-smirkwink | E2 squat recipe | anifox-v2-baseline | 2026092586 | `4f287fb5-752b-40bc-a7f4-2c3529ebba9d` |
| p58-jeanne-smirkwink | E2 squat recipe | cstati-v3-baseline | 2026092587 | `ef7500c6-beff-41b3-acc2-b0beb1eceb49` |
...
All six completed, 22.8–26.8 s each, no spill. G15 ports 2/2; Kafka eyes 1/2; Yor's lab-place fix holds (equipment nouns work); B1 Cissia clean, Promeia partial.

- p68-kafka-labcoat-anima, Anima, seed `2026092642`, job `37d0b80a`, prompt `6068a8dd`, 26.4 s, `Anima-v1-Baseline_00072_.png`. Identity: Kafka reads, magenta hair, white coat over a black blouse and skirt, beakers violet night, adult. Lever: G15 port — full lab-coat read with no sheer LoRA. Squat held. Hands: hidden behind the head. Eyes closed, the Anima squat pattern. Cloth: coat, blouse, and skirt opaque. Keep-or-change: keep; G15 ports 1/2.
- p68-yor-labcoat-janima, JANIMA, seed `2026092643`, job `d4df9293`, prompt `5f806bf1`, 22.8 s, `JANIMA-v1-Baseline_00034_.png`. Identity: Yor reads, black hair, headband, white coat over a red blouse and black skirt, monitors and beakers, night, adult. Lever: G15 port with the equipment nouns — lab reads on the port too. Squat held. Hands: hidden behind the head. Eyes open. Cloth: coat, blouse, and skirt opaque. Keep-or-change: keep; G15 ports 2/2.
- p68-kafka-labcoat-eyes, WAI, seed `2026092445`, job `6b8835c4`, prompt `8a024cb8`, 26.8 s, `WAI-Illustration_00141_.png`. Identity: Kafka reads, coat, blouse, and skirt intact, lab night, adult. Lever: `bedroom eyes` — half-lidded eyes, outfit intact. Squat held. Hands: hidden behind the head. Cloth: white blouse sheer, coat and skirt glossy. Keep-or-change: keep; G15 eyes 1/2.
- p68-yor-labcoat-labfix, CSTati, seed `2026092446`, job `497b66c3`, prompt `75db95f7`, 26.3 s, `CSTati-v3-Baseline_00127_.png`. Identity: Yor reads, coat over a pinkish blouse and black skirt, monitors and lamp night, adult. Lever: lab-place fix with `monitors and beakers` — screens present now, place reads lab-office. Squat held. Hands: hidden behind the head. Cloth: blouse sheer, black skirt glossy. Keep-or-change: keep; the equipment-noun rule holds, G15 garment+place now 2/2.
- p68-cissia-smallbust, AniFox, seed `2026092628`, job `84b8259f`, prompt `ccf1c512`, 24.2 s, `AniFox-v2-Baseline_00090_.png`. Identity: Cissia reads as a dark-haired strategist in a white shirt and tie among office monitors at night, adult; first-run face, likeness note only. Lever: B1 first try — bust reads modest under the shirt. Squat held, smirk and wink show. Hands: hidden behind the head. Cloth: white shirt translucent-sheer, black pants glossy. Keep-or-change: keep; B1 clean.
- p68-promeia-smallbust, CSTati, seed `2026092629`, job `40c369b2`, prompt `486e99cb`, 26.2 s, `CSTati-v3-Baseline_00128_.png`. Identity: Promeia reads as a blonde in a dark teal and gold dress, office lamp night, adult; first-run face, likeness note only. Lever: B1 first try — bust reads moderate. Squat held, smirk and wink show. Hands: hidden behind the head. Cloth: dark dress glossy. Keep-or-change: keep as a partial.

## G15 eyes-close, sheer-off close, B1 Jane through Grace — p69 wave

P68 held 6/6 — G15 ports 2/2, Kafka eyes 1/2, Yor lab-place fix holds (garment+place 2/2), B1 Cissia clean and Promeia partial (B1 now 4 clean, 11 partial, 1 break across 16 faces). This wave runs Yor's eyes cell, closes G15 with the sheer stack off at the same seed on both G-series seeds, and runs B1 on three more cleared adults (Jane, Nicole, Grace — all cleared for new cells). Six cells, queued in one burst, no refusals.

Submit note (honest): the Yor-eyes cell below went out with the sheer stack OFF (no `lora2_name`, no sheer head) — a submit-script branching slip, so it reads as a sheer-off+eyes combined cell, not the clean same-seed eyes test. It is judged as a combined read; a clean Yor-eyes-with-sheer rerun (new prompt, same seed) follows in the next wave before G15 eyes counts 2/2.

| Cell | Held cell | Preset | Seed | Job |
| --- | --- | --- | --- | --- |
| p69-yor-labcoat-eyes-combined | p68-yor-labcoat-labfix | cstati-v3-baseline | 2026092446 | `bb06e405-10e1-4acd-a637-e72446642c22` |
| p69-kafka-labcoat-nolora | p67-kafka-labcoat | wai | 2026092445 | `6f1f5ffa-f356-4b13-b7e8-bb4998540d3b` |
| p69-yor-labcoat-nolora | p68-yor-labcoat-labfix | cstati-v3-baseline | 2026092446 | `093a0526-24a1-4ff2-aae8-ac0130373c67` |
| p69-jane-smallbust | B1 recipe | anifox-v2-baseline | 2026092630 | `b018f5fe-8c1f-498d-be93-723a39da5d6f` |
...
All six completed, 24.2–28.4 s each, no spill. G15 closes with the clean Yor-eyes rerun (garment+place 2/2, ports 2/2, eyes 2/2, sheer 2/2); G16 opened 2/2 and promotes; B1 Yanagi and Miyabi clean, Rina partial.

- p70-yor-labcoat-eyes, CSTati, seed `2026092446`, job `6fa103ad`, prompt `23f9852b`, 28.4 s, `CSTati-v3-Baseline_00132_.png`. Identity: Yor reads, coat over a white blouse and black skirt, monitors and lamp night, adult. Lever: clean `bedroom eyes` with the sheer stack on — half-lidded red eyes show, outfit intact, blouse sheer. Squat held. Hands: hidden behind the head. Cloth: white blouse sheer, black skirt glossy. Keep-or-change: keep; G15 eyes 2/2, G15 closes.
- p70-kafka-cheer, WAI, seed `2026092445`, job `bb1a9b05`, prompt `f480dff8`, 26.3 s, `WAI-Illustration_00144_.png`. Identity: Kafka reads, magenta hair, sunglasses on the head, red and white cheer top with a pleated skirt, stadium night, adult. Lever: outfit to cheerleader — full read, pleated skirt stays structured in the squat. Squat held. Hands: hidden behind the head. Cloth: red top glossy, pleated skirt glossy. Keep-or-change: keep; G16 1/2.
- p70-yor-cheer, CSTati, seed `2026092446`, job `70526c9e`, prompt `bc8869e4`, 26.5 s, `CSTati-v3-Baseline_00133_.png`. Identity: Yor reads, black hair, headband, red and white cheer top with a pleated skirt, stadium lamps, adult. Lever: outfit to cheerleader — full read again, skirt stays down. Squat held. Hands: hidden behind the head. Cloth: red top glossy, pleated skirt structured. Keep-or-change: keep; G16 2/2, promotes.
- p70-yanagi-smallbust, AniFox, seed `2026092633`, job `40aea6ee`, prompt `ffdb63fb`, 26.3 s, `AniFox-v2-Baseline_00092_.png`. Identity: Yanagi reads, blonde hair, black and white investigator uniform with tie, neon street night, adult. Lever: B1 first try — bust reads modest under the shirt. Squat held, smirk and wink show. Hands: hidden behind the head. Cloth: white shirt translucent-sheer, black jacket and pants glossy. Keep-or-change: keep; B1 clean.
- p70-rina-smallbust, CSTati, seed `2026092634`, job `31a29a49`, prompt `76a6486a`, 28.3 s, `CSTati-v3-Baseline_00134_.png`. Identity: Rina reads, dark blue hair, maid headdress, black and white french maid uniform, mansion lamp night, adult. Lever: B1 first try — bust reads moderate in the white bodice. Squat held, smirk and wink show. Hands: hidden behind the head. Cloth: white bodice glossy, black dress glossy. Keep-or-change: keep as a partial.
- p70-miyabi-smallbust, WAI, seed `2026092635`, job `44638612`, prompt `7f242f64`, 24.2 s, `WAI-Illustration_00145_.png`. Identity: Miyabi reads, dark blue hair with fox ears, black and white void-hunter uniform with green tie, neon street night, adult. Lever: B1 first try — bust reads modest. Squat held, smirk and wink show. Hands: hidden behind the head. Cloth: black uniform glossy. Keep-or-change: keep; B1 clean.

## G16 ports and eyes, B1 Yuzuha and Alice — p71 wave

P70 held 6/6 — G15 closed (all four reads), G16 promoted on the opening pair, B1 Yanagi and Miyabi clean and Rina partial (B1 now 8 clean, 13 partial, 1 break across 22 faces). This wave ports G16 to both families with no sheer LoRA, adds `bedroom eyes` to both cheer cells at the same seed, and runs B1 on two more cleared adults (Yuzuha, Alice — both cleared for new cells). Six cells, queued in one burst, no refusals.

| Cell | Held cell | Preset | Seed | Job |
| --- | --- | --- | --- | --- |
| p71-kafka-cheer-anima | p70-kafka-cheer | anima-v1-baseline | 2026092644 | `c1a5bc35-b8a4-439e-90d5-59f6286ed1d1` |
| p71-yor-cheer-janima | p70-yor-cheer | janima-v1-baseline | 2026092645 | `9f6df1ed-8120-403f-8c4e-7b6d6192e5e0` |
| p71-kafka-cheer-eyes | p70-kafka-cheer | wai | 2026092445 | `70fbd70d-7c2b-4f72-837c-3e789ba5acbc` |
| p71-yor-cheer-eyes | p70-yor-cheer | cstati-v3-baseline | 2026092446 | `ae6435ad-9b75-4f06-86b9-0b8efc0ad691` |
...
| --- |--------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Ye Shunguang | 18                                         | Pending.                                                                                                                                                                                                   |
| Sunna | 18–19, "almost an adult"                   | Pending.                                                                                                                                                                                                   |
| Nangong | 18–19                                      | Pending.                                                                                                                                                                                                   |
...
| Aria | 110–120 chrono, sentient construct         | Pending.                                                                                                                                                                                                   |
