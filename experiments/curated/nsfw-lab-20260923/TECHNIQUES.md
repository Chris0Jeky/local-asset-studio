...
Swap the outfit nouns for a black and white maid outfit at the same seed: blouse, bodice, skirt, bow, and sheer panels (`p42-kafka-maid`, WAI, job `588c5636`, prompt `14147e70`, `WAI-Illustration_00092_.png`, 28.3 s, mouth slightly open, eyes heavy), dress with white trim, sleeves, and choker (`p42-yor-maid`, CSTati, job `752bdde9`, prompt `fde214f1`, `CSTati-v3-Baseline_00077_.png`, 26.3 s, mouth closed). Squats held, hands hidden, both glossy and wet. Two characters held it, so it promotes. Untested off the Illustrious family; untested with the sheer stack off.

Next lever (p43, queued): G7 on the ports, eyes on G7, Evelyn, Ruan Mei.
