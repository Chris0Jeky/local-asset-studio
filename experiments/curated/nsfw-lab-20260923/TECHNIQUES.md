...
Swap the outfit nouns for a bunny suit at the same seed: black ears, bowtie, leotard, and stockings in latex gloss (`p37-kafka-bunny`, WAI, job `ecb9ec29`, prompt `d68ed9a2`, `WAI-Illustration_00084_.png`, 24.3 s, mouth slightly open, eyes heavy), red ears, bowtie, and leotard glossy and wet (`p37-yor-bunny`, CSTati, job `0546fb53`, prompt `1e9783e9`, `CSTati-v3-Baseline_00068_.png`, 24.3 s, mouth closed). Squats held, hands hidden. Two characters held it, so it promotes. Untested off the Illustrious family; untested with the sheer stack off.

Next lever (p38, queued): G5 on the ports, eyes on G5, two more new adults, E1 on the Anima crawl.
