...
Next lever (p55, queued): G12 flight-attendant open x2, Aqua, Lucy, Himeno, Himeko.

Eligibility intake, evening of 24 September: the owner pasted a community ZZZ age guide whose headline finding is that HoYoverse has confirmed no exact ZZZ age; 15 names were evaluated in FINDINGS.md (3 teen estimates excluded, Ellen stays dropped, 2 non-human/unknown excluded, 8 cleared, Nicole corrected as already-run). Correction same evening: the owner confirmed Aqua ("clearly an adult and a goddess canonically and already portrayed maturely") and ruled that a missing stated number is not by itself a reason to remove characters — so Aqua stays (wildcard line restored), the 8 pending ZZZ names are owner-confirmed eligible, and new cells for the already-run five (Jane, Nicole, Rina, Grace, Yanagi) are cleared. Teen estimates, students, and non-human/unknown entries stay excluded: that is affirmative under-18 or unratable evidence, not ambiguity.
