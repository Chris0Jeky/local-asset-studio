...
G10 candidate (police uniform, unpromoted): Yor reads full police (`p48-yor-police`, CSTati, job `57118102`, prompt `dd67297d`, `CSTati-v3-Baseline_00088_.png`, 28.2 s, badge, patches, blue shirt, tie, black pants), Kafka reads generic cop-play with no badge, cap, or blue (`p48-kafka-police`, WAI, job `83179448`, prompt `cdcdcfc9`, `WAI-Illustration_00106_.png`, 30.3 s). G10 stands 1.5/2: the nouns under-specify on WAI. No section until the badge fix holds on both.

Next lever (p49, queued): G10 badge fix x2, eyes on Yor's police cell, Rina, Serval, Beidou.
