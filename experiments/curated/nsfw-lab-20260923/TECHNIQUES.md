...
Swap the outfit nouns for a red and white shrine-maiden outfit at the same seed: haori with red trim and red hakama with a bow (`p44-kafka-miko`, WAI, job `edd6aabb`, prompt `b3208c2d`, `WAI-Illustration_00097_.png`, 32.5 s, mouth slightly open, eyes heavy), miko top, hakama, and choker with translucent panels (`p44-yor-miko`, CSTati, job `619b2bfe`, prompt `07b8398a`, `CSTati-v3-Baseline_00080_.png`, 30.4 s, mouth closed). Squats held, hands hidden, both glossy and wet. Two characters held it, so it promotes. Untested off the Illustrious family; untested with the sheer stack off.

Next lever (p45, queued): G8 on the ports, eyes on G8, Lisa, Grace.
