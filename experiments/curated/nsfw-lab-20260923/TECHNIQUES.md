...
Swap the outfit nouns for a white and pink nurse uniform at the same seed: cap, dress with buttons, and name tag (`p46-kafka-nurse`, WAI, job `ca431745`, prompt `e12d7a09`, `WAI-Illustration_00101_.png`, 30.3 s, mouth slightly open, eyes heavy), cap, dress, and name tag (`p46-yor-nurse`, CSTati, job `1b960258`, prompt `f7ab5680`, `CSTati-v3-Baseline_00085_.png`, 28.2 s, mouth closed). Squats held, hands hidden, both glossy and wet. Two characters held it, so it promotes. Untested off the Illustrious family; untested with the sheer stack off.

Next lever (p47, queued): G9 on the ports, eyes on G9, Jean, Natasha.
