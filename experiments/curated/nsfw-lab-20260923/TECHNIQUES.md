...
Swap the outfit nouns for a qipao dress at the same seed: black mandarin collar with knot, side slits, and sheer skirt panel in satin gloss (`p40-kafka-qipao`, WAI, job `ea0acd17`, prompt `4a07dc65`, `WAI-Illustration_00088_.png`, 24.2 s, mouth slightly open, eyes heavy), red collar, black trim, and high slits glossy and wet (`p40-yor-qipao`, CSTati, job `a8f3eee7`, prompt `de8c6822`, `CSTati-v3-Baseline_00072_.png`, 24.2 s, mouth closed). Squats held, hands hidden. Two characters held it, so it promotes. Untested off the Illustrious family; untested with the sheer stack off.

Next lever (p41, queued): G6 on the ports, eyes on G6, Wicke, Burnice.
