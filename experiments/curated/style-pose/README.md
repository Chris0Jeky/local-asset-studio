...
the 283 s is dominated by first loads of four model files (checkpoint, CLIP vision, IP-Adapter, ControlNet) and the OpenPose annotators. This is neither art acceptance nor licence
